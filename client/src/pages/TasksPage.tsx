  ...
  const handleSpeech = () => {
    ...
    recognition.onresult = async (event: any) => {
      ...
      try {
        ...
        setMessage(res.data.message || "Task processed successfully!");

        if (res.data.intent === "add_task") {
          tasksService.getTasks().then(setTasks);
        }
      } catch (error: any) {
        console.error("Voice processing error:", error);
        setMessage(
          error.response?.data?.message || "Error processing your speech."
        );
      }
    };
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div style={{ marginBottom: "20px", textAlign: "center" }}>
          <button
            ...
            disabled={listening}
            style={{
              backgroundColor: listening ? "#999" : "#007bff",
              color: "white",
              border: "none",
              borderRadius: "10px",
              padding: "10px 20px",
          ...
          >
            {listening ? "🎧 Listening..." : "🎙️ Speak to Add Task"}
          </button>
          ...
          <div className="mb-8">
            ...
            <div className="space-y-3">
              {incompleteTasks.map((task) => (
                <div key={task._id} className="bg-white rounded-lg shadow-md p-4 hover:shadow-lg transition-shadow">
                      ...
                      {editingTask === task._id ? (
                        <div className="mt-2 flex items-center gap-2">
                          ...
                          <input
                            ...
                            onChange={(e) =>
                              handleUpdateDueDate(task._id, e.target.value)
                            }
